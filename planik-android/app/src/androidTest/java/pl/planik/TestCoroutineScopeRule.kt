 ...
 * ```
 *
 * All coroutines started on [TestCoroutineScopeRule] must complete (including timeouts) before the test
 ...
 * ```
 *
 * You may call [DelayController] methods on [TestCoroutineScopeRule] and they will control the
 * virtual-clock.
 *
 * ```
 ...
 * ```
 *
 * By default, [TestCoroutineScopeRule] will be in a *resumed* state.
 *
